...
module.exports = function(type_id, price, num, info, area, bed, type, standard, wifi, cigarette, hotel_id, img) {
    ...
    pool.getConnection(function(err, connection){
        var sql = 'insert into room_type(room_type_id, room_price, room_num, room_area, '+
            'room_bed, room_type_name, room_standard, room_wifi, room_cigarette, '+
            'hotel_hotel_id, room_img) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ';
