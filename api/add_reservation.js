...
module.exports = function(arrival, leave, roomtypeid, userid, num, other_mates, price) {
	pool.getConnection(function(err, connection){
        ...
        var sql = 'insert into reservation(reser_id, reser_status, reser_begin, reser_end, customer_customer_id, room_type_room_type_id, reser_num_room, other_mates, reser_price) values(?, ?, ?, ?, ?, ?, ?, ?, ?) ';
