...
module.exports = function(arrival, leave, roomtypeid, userid) {
	pool.getConnection(function(err, connection){
        ...
        var sql = 'insert into reservation(reser_id, reser_status, reser_begin, reser_end, customer_customer_id, room_type_room_type_id) values(?, ?, ?, ?, ?, ?) ';
		var user = [res_id, "Unpayed",arrival, leave, userid, roomtypeid];
